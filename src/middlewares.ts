 ...
 */
export const authRequired = (options: AuthRequiredOptions | undefined = undefined) =>
  expressjwt({
 ...
 */
export const handleUnauthorizedError = (err: Error, _req: Request, res: Response, next: NextFunction) => {
